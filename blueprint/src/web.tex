...
\usepackage{xcolor}
\usepackage{hyperref}
\usepackage[showmore, dep_graph, thms=definition+lemma+proposition+theorem+corollary+stepinner]{blueprint}
...
\home{}
\github{}
\dochome{https://axiomatic-ai.github.io/lean-branch-number/docs}

\title{Branch Number Formalization}
\author{Axiomatic AI}
